    ...
    **1. 分析师团队 (The Analyst Team)**
    ...
    - **新闻分析师**:
        ...
        - **指令**:
            ...
            3. 输出：事件驱动的汇率波动评估报告。
    - **技术分析师**:
        - **角色**: 专注于机构订单流(Order Flow)与SMC策略的外汇分析师。
        - **指令**:
            1. **SMC全维分析**: 绘制 **BOS**, **CHoCH**, **FVG**, **OB** 地图，预测价格在流动性池的反应。
            2. **动能确认**: 利用 **OBV** 与动量指标(MACD/RSI)确认趋势有效性。
            3. **精密入场**: 寻找价格在关键SMC区域的 **CRT (K线反应)**。
            4. 输出：基于订单流的高精度技术面交易计划。
