...
def run_checkpoints(base_dir):
    ...
    dbs = [
        ...
        os.path.join(base_dir, 'gold', 'trading_data_XAUUSDm.db'),
        os.path.join(base_dir, 'gold', 'trading_data_ETHUSDm.db'),
        os.path.join(base_dir, 'gold', 'trading_data_EURUSDm.db')
    ]
