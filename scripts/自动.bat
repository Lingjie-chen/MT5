...
:: This script handles DB WAL checkpointing and cleaning up synced local DBs
echo [%DATE% %TIME%] Running DB Checkpoint & Cleanup...
python scripts/checkpoint_dbs.py --cleanup
